...
export const loginCard =
  'flex flex-col items-center justify-center self-center p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 m-8 w-full lg-96 bg-gray-50  md:w-full'
